...
class NetLogoOrchestratorSimplified:
    ...
    async def process_netlogo_file_parallel_first_stage(self, file_info: Dict[str, Any]) -> Dict[str, Any]:
        ...
        run_dir = self.fileio.create_run_directory(self.timestamp, base_name, self.model, reff, tv, self.selected_persona_set, version="v2")
        ...
        async def run_syntax():
            ...
            run_dir = get_run_base_dir(self.timestamp, base_name, self.model, reff or "medium", tv or "medium", self.selected_persona_set, version="v2")
