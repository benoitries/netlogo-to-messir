# Reference Orchestrator (Canonical — ADK v3)
...
- File: `code-netlogo-to-lucim-agentic-workflow/orchestrator_persona_v3_adk.py`
- Purpose: Persona v3 limited-agents, 3-stage iterative pipeline (Generator ↔ Auditor per stage)
- Status: Canonical implementation for the multi-agent workflow

## Rationale

The repository contains legacy and ADK-based orchestrators. To avoid ambiguity, `orchestrator_persona_v3_adk.py` is the single source of truth for:
- Stage ordering and iteration logic (3-stage ADK v3 flow)
...
```bash
python /Users/benoit.ries/Library/CloudStorage/OneDrive-UniversityofLuxembourg/cursor-workspace-individual/research.publi.reverse.engineering.netlogo.to.messir.ucid/code-netlogo-to-lucim-agentic-workflow/orchestrator_persona_v3_adk.py
```
...
- Orchestration flow details (SSOT): `code-netlogo-to-lucim-agentic-workflow/docs/orchestration-flow.md`
