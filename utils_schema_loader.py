...
from utils_config_constants import (
    PERSONA_LUCIM_OPERATION_MODEL_GENERATOR,
    PERSONA_LUCIM_OPERATION_MODEL_AUDITOR,
    PERSONA_LUCIM_SCENARIO_GENERATOR,
    PERSONA_LUCIM_SCENARIO_AUDITOR,
    PERSONA_LUCIM_PLANTUML_DIAGRAM_GENERATOR,
    PERSONA_LUCIM_PLANTUML_DIAGRAM_AUDITOR,
)
...
AGENT_TO_PERSONA = {
    ...
    "lucim_plantuml_diagram_auditor": PERSONA_LUCIM_PLANTUML_DIAGRAM_AUDITOR,
}
